function love.conf(t)
    t.identity = "traces" -- The name of the save directory (string)
    ...
    t.window.title = "TRACES" -- The window title (string)
    ...
    t.window.msaa = 0 -- The number of samples to use with multi-sampled
